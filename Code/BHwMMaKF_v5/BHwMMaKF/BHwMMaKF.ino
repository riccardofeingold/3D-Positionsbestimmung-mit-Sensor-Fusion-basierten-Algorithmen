...
void LEARN()
{
  ...
  if (current_time - MesurementPreviousMillis >= measurement_interval)
  {
    ...
    { 
      ...
      uint16_t hoehe = searchPrecise(lat, lon, true);//Height estimator: Mathematical Model
      

      lcd.setCursor(8,0);
      lcd.print("v=");
      lcd.print(v); //Is the velocity in m/s
      ...
      lcd.setCursor(0,0);
      lcd.print("hM=");
      lcd.print(estimated_height);//Estimated height
      ...
      //GPS Height 
      lcd.setCursor(0,3);
      lcd.print("hG="); lcd.println(GPS.altitude,1);
